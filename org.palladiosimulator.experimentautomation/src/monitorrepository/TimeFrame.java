 ...
 * <ul>
 * <li>{@link monitorrepository.TimeFrame#getStart <em>Start</em>}</li>
 * <li>{@link monitorrepository.TimeFrame#getStop <em>Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @see monitorrepository.MonitorrepositoryPackage#getTimeFrame()
 * @model
 * @generated
 */
public interface TimeFrame extends TemporalCharacterization {
     ...
     * @see #setStart(double)
     * @see monitorrepository.MonitorrepositoryPackage#getTimeFrame_Start()
    ...
    /**
     * Sets the value of the '{@link monitorrepository.TimeFrame#getStart <em>Start</em>}'
     ...
     * @see #setStop(double)
     * @see monitorrepository.MonitorrepositoryPackage#getTimeFrame_Stop()
     * @model default="0.0" required="true"
     * @generated
     */
    double getStop();
    ...
    /**
     * Sets the value of the '{@link monitorrepository.TimeFrame#getStop <em>Stop</em>}' attribute.
