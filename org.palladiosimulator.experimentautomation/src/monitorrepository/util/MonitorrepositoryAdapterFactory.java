/**
 */
package monitorrepository.util;

import monitorrepository.DelayedIntervall;
import monitorrepository.Intervall;
import monitorrepository.MeasurementSpecification;
import monitorrepository.Monitor;
import monitorrepository.MonitorRepository;
import monitorrepository.MonitorrepositoryPackage;
import monitorrepository.TemporalCharacterization;
import monitorrepository.TimeFrame;
 ...
 *
 * @see monitorrepository.MonitorrepositoryPackage
 * @generated
 */
public class MonitorrepositoryAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '{@link monitorrepository.MonitorRepository
    ...
    /**
     * Creates a new adapter for an object of class '{@link monitorrepository.Monitor
     * <em>Monitor</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
     ...
     * {@link monitorrepository.MeasurementSpecification <em>Measurement Specification</em>}'. <!--
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link monitorrepository.TemporalCharacterization <em>Temporal Characterization</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
    ...
    /**
     * Creates a new adapter for an object of class '{@link monitorrepository.Intervall
     * <em>Intervall</em>}'. <!-- begin-user-doc --> This default implementation returns null so
    ...
    /**
     * Creates a new adapter for an object of class '{@link monitorrepository.DelayedIntervall
    ...
    /**
     * Creates a new adapter for an object of class '{@link monitorrepository.TimeFrame
     * <em>Time Frame</em>}'. <!-- begin-user-doc --> This default implementation returns null so
     * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
     * the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
