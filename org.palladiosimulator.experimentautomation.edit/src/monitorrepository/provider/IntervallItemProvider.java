...
/**
 * This is the item provider adapter for a {@link monitorrepository.Intervall} object. <!--
...
public class IntervallItemProvider extends TemporalCharacterizationItemProvider {
    ...
    public String getText(final Object object) {
        final String label = ((Intervall) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_Intervall_type") : this
