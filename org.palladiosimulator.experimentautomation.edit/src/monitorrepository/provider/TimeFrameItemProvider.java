...
/**
 * This is the item provider adapter for a {@link monitorrepository.TimeFrame} object. <!--
...
public class TimeFrameItemProvider extends TemporalCharacterizationItemProvider {
    ...
    public String getText(final Object object) {
        final String label = ((TimeFrame) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_TimeFrame_type") : this
