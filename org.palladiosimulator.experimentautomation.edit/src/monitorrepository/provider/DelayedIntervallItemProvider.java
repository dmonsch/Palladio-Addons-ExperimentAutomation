/**
 */
package monitorrepository.provider;
...
/**
 * This is the item provider adapter for a {@link monitorrepository.DelayedIntervall} object. <!--
...
public class DelayedIntervallItemProvider extends IntervallItemProvider {
    ...
    public String getText(final Object object) {
        final String label = ((DelayedIntervall) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_DelayedIntervall_type") : this
