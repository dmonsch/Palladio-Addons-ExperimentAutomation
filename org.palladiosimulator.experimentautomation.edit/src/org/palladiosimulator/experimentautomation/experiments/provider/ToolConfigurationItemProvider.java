 ...
 * {@link org.palladiosimulator.experimentautomation.experiments.ToolConfiguration} object. <!--
...
public class ToolConfigurationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getResourceLocator(),
                getString("_UI_ToolConfiguration_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_ToolConfiguration_name_feature",
    ...
    public String getText(Object object) {
        String label = ((ToolConfiguration) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ToolConfiguration_type")
