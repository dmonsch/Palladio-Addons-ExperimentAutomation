...
public class AbstractsimulationActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                AbstractsimulationActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        @Override
        public void run() {
            if (AbstractsimulationActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) AbstractsimulationActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
