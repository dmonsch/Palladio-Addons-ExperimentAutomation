...
/**
 * Runs a given, completely specified experiment out of an experiment run
 * series.
 * 
...
public class RunExperimentJob extends SequentialBlackboardInteractingJob<MDSDBlackboard> {
	 ...
	 * @param repetition
	 *            Gives the current number of repetitions for this exact
	 *            experiment; for statistical significance. Note that
	 *            repetition>1 makes only sense for non-fixed random seeds.
	 */
