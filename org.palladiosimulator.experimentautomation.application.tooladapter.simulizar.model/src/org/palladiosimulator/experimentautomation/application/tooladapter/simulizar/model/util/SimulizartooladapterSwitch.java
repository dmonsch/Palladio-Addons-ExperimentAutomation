...
public class SimulizartooladapterSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case SimulizartooladapterPackage.SIMU_LIZAR_CONFIGURATION: {
            final SimuLizarConfiguration simuLizarConfiguration = (SimuLizarConfiguration) theEObject;
            T result = this.caseSimuLizarConfiguration(simuLizarConfiguration);
            if (result == null) {
                result = this.caseAbstractSimulationConfiguration(simuLizarConfiguration);
            }
            if (result == null) {
                result = this.caseToolConfiguration(simuLizarConfiguration);
            }
            if (result == null) {
     ...
     * <em>Simu Lizar Configuration</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Simu Lizar Configuration</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSimuLizarConfiguration(final SimuLizarConfiguration object) {
        return null;
    }
