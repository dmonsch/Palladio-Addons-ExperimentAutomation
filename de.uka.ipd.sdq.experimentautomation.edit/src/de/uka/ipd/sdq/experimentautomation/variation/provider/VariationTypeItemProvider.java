...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.variation.VariationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationType_name_feature", "_UI_VariationType_type"),
	...
	protected void addStrategyClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationType_strategyClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationType_strategyClass_feature", "_UI_VariationType_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationType_variedEntityInterface_feature", "_UI_VariationType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_VariationType_type") :
