...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.experiments.abstractsimulation.MeasurementCountStopCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementCountStopConditionItemProvider
	extends StopConditionItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasurementCountStopCondition_measurementCount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasurementCountStopCondition_measurementCount_feature", "_UI_MeasurementCountStopCondition_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_MeasurementCountStopCondition_type") + " " + measurementCountStopCondition.getMeasurementCount();
	}
