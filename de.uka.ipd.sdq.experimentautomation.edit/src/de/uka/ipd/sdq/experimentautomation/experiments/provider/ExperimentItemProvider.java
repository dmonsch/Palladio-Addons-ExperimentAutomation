...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.experiments.Experiment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addToolConfigurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Experiment_toolConfiguration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Experiment_toolConfiguration_feature", "_UI_Experiment_type"),
