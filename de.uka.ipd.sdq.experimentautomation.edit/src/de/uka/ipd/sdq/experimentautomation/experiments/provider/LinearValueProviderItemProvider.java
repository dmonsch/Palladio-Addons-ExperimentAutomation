...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.experiments.LinearValueProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinearValueProviderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LinearValueProvider_summand_feature", "_UI_LinearValueProvider_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LinearValueProvider_factor_feature", "_UI_LinearValueProvider_type"),
