...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.experiments.abstractsimulation.FileDatasource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileDatasourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FileDatasource_location_feature", "_UI_FileDatasource_type"),
	...
	public String getText(Object object) {
		String label = ((FileDatasource)object).getLocation();
		return label == null || label.length() == 0 ?
			getString("_UI_FileDatasource_type") :
