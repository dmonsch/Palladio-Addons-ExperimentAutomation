...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.experimentautomation.experiments.Variation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_type_feature", "_UI_Variation_type"),
	...
	protected void addMinValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_minValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_minValue_feature", "_UI_Variation_type"),
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_maxValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_maxValue_feature", "_UI_Variation_type"),
	...
	protected void addMaxVariationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_maxVariations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_maxVariations_feature", "_UI_Variation_type"),
	...
	protected void addVariedObjectIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_variedObjectId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_variedObjectId_feature", "_UI_Variation_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variation_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variation_name_feature", "_UI_Variation_type"),
