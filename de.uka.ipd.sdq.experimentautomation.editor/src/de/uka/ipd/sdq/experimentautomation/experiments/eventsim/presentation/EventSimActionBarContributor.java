...
/**
 * This is the action bar contributor for the EventSim model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class EventSimActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                ExperimentAutomationEditorPlugin.INSTANCE.getString("_UI_EventSimEditor_menu"),
                "de.uka.ipd.sdq.experimentautomation.experiments.eventsimMenuID");
