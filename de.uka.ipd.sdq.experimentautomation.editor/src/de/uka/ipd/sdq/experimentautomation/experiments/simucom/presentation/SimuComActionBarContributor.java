...
/**
 * This is the action bar contributor for the SimuCom model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class SimuComActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                ExperimentAutomationEditorPlugin.INSTANCE.getString("_UI_SimuComEditor_menu"),
                "de.uka.ipd.sdq.experimentautomation.experiments.simucomMenuID");
