/**
 */
package de.uka.ipd.sdq.experimentautomation.simucom;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.experimentautomation.simucom.SimucomFactory
 * @model kind="package"
 * @generated
 */
public interface SimucomPackage extends EPackage {
     ...
     * @generated
     */
    String eNS_URI = "http://sdq.ipd.uka.de/ExperimentAutomation/SimuCom/1.0";
     ...
     * @generated
     */
    SimucomPackage eINSTANCE = de.uka.ipd.sdq.experimentautomation.simucom.impl.SimucomPackageImpl.init();

    /**
     * The meta object id for the '{@link de.uka.ipd.sdq.experimentautomation.simucom.impl.SimuComConfigurationImpl <em>Simu Com Configuration</em>}' class.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @see de.uka.ipd.sdq.experimentautomation.simucom.impl.SimuComConfigurationImpl
     * @see de.uka.ipd.sdq.experimentautomation.simucom.impl.SimucomPackageImpl#getSimuComConfiguration()
     * @generated
     */
    ...
    /**
     * Returns the meta object for class '{@link de.uka.ipd.sdq.experimentautomation.simucom.SimuComConfiguration <em>Simu Com Configuration</em>}'.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @return the meta object for class '<em>Simu Com Configuration</em>'.
     * @see de.uka.ipd.sdq.experimentautomation.simucom.SimuComConfiguration
     * @generated
     */
    ...
    interface Literals {
        /**
         * The meta object literal for the '{@link de.uka.ipd.sdq.experimentautomation.simucom.impl.SimuComConfigurationImpl <em>Simu Com Configuration</em>}' class.
         * <!-- begin-user-doc --> <!-- end-user-doc -->
         * @see de.uka.ipd.sdq.experimentautomation.simucom.impl.SimuComConfigurationImpl
         * @see de.uka.ipd.sdq.experimentautomation.simucom.impl.SimucomPackageImpl#getSimuComConfiguration()
         * @generated
