 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#getPersistenceFramework <em>Persistence Framework</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#getStopConditions <em>Stop Conditions</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#getRandomNumberGeneratorSeed <em>Random Number Generator Seed</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#isSimulateLinkingResources <em>Simulate Linking Resources</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#isSimulateFailures <em>Simulate Failures</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.impl.AbstractSimulationConfigurationImpl#getProbeSpecConfiguration <em>Probe Spec Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
