 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.ProbeSpecConfiguration#getBlackboardType <em>Blackboard Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.experimentautomation.abstractsimulation.AbstractsimulationPackage#getProbeSpecConfiguration()
 * @model
 * @generated
 */
public interface ProbeSpecConfiguration extends EObject {
     ...
     * The literals are from the enumeration {@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.BlackboardType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.uka.ipd.sdq.experimentautomation.abstractsimulation.AbstractsimulationPackage#getProbeSpecConfiguration_BlackboardType()
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.experimentautomation.abstractsimulation.ProbeSpecConfiguration#getBlackboardType <em>Blackboard Type</em>}' attribute.
