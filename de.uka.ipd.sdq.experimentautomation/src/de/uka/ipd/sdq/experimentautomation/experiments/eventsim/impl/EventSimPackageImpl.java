...
public class EventSimPackageImpl extends EPackageImpl implements EventSimPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link EventSimPackage#eINSTANCE} when that field is
    ...
    public static EventSimPackage init() {
        if (isInited)
            return (EventSimPackage) EPackage.Registry.INSTANCE.getEPackage(EventSimPackage.eNS_URI);

        // Obtain or create and register package
        EventSimPackageImpl theEventSimPackage = (EventSimPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EventSimPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new EventSimPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        eventSimConfigurationEClass.getESuperTypes().add(
                theAbstractSimulationPackage.getAbstractSimulationConfiguration());

        // Initialize classes and features; add operations and parameters
        initEClass(eventSimConfigurationEClass, EventSimConfiguration.class, "EventSimConfiguration", !IS_ABSTRACT,
