...
public class AbstractSimulationFactoryImpl extends EFactoryImpl implements AbstractSimulationFactory {
	...
	public static AbstractSimulationFactory init() {
		try {
			AbstractSimulationFactory theAbstractSimulationFactory = (AbstractSimulationFactory)EPackage.Registry.INSTANCE.getEFactory("http://sdq.ipd.uka.de/ExperimentAutomation/Experiments/AbstractSimulation/1.0"); 
