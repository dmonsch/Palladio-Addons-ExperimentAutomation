...
public class ExperimentsFactoryImpl extends EFactoryImpl implements ExperimentsFactory {
	...
	public static ExperimentsFactory init() {
		try {
			ExperimentsFactory theExperimentsFactory = (ExperimentsFactory)EPackage.Registry.INSTANCE.getEFactory("http://sdq.ipd.uka.de/ExperimentAutomation/Experiments/1.0"); 
