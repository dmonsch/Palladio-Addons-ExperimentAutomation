...
public class SimuComFactoryImpl extends EFactoryImpl implements SimuComFactory {
    ...
    public static SimuComFactory init() {
        try {
            SimuComFactory theSimuComFactory = (SimuComFactory) EPackage.Registry.INSTANCE
                    .getEFactory("http://sdq.ipd.uka.de/ExperimentAutomation/Experiments/SimuCom/1.0");
