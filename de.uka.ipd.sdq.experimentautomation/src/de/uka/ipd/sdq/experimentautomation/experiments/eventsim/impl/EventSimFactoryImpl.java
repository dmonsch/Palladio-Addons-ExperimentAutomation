...
public class EventSimFactoryImpl extends EFactoryImpl implements EventSimFactory {
	...
	public static EventSimFactory init() {
		try {
			EventSimFactory theEventSimFactory = (EventSimFactory)EPackage.Registry.INSTANCE.getEFactory("http://sdq.ipd.uka.de/ExperimentAutomation/Experiments/EventSim/1.0"); 
